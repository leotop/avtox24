...
<script src="<?=SERVICE_DIRECTORY?>/media/js/ZeroClipboard.js"></script>
<script src="<?=SERVICE_DIRECTORY?>/media/js/base.js"></script>
...
<script>
    ...
    function readyZeroClipboard(){
        ...
        ZeroClipboard.setMoviePath('<?=SERVICE_DIRECTORY?>/media/js/ZeroClipboard.swf');
        setTimeout( function( ){
