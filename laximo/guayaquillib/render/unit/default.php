<?php
    ...
    class GuayaquilUnit extends GuayaquilTemplate
    {
        ...
        {
            $html = '<div style="width:49%; height:100%;" class="inline_block details-tree">';

            $html .= $this->unitimagerenderer->Draw($catalog, $unit, $imagemap);

            $html .= '<div class="unit-resize-image"><span>Увеличить изображение</span><span>Уменьшить изображение</span></div>';
            $html .= '</div>';
        ...
        {   
            ...
            $html .= '<div class="tree-list-titles">
            <div>№</div>
            <div>Описание</div>
            </div>';
