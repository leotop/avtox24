...
class GuayaquilDetailsList extends GuayaquilTemplate
{
    ...
    var $columns = array('PNC' => 3, 'Name' => 3, "pricelink" => 3/*'Cart' => 1, 'Note' => 2, 'Tooltip' => 1*/ );
    var $basic_columns = array('PNC' => 1, 'OEM' => 3, 'Name' => 3, 'Cart' => 1, 'Tooltip' => 1, 'flag' => 1, 'availability' => 1, 'Note' => 2, "pricelink" => 3);
    ...
    {
        return '<tr>
            <td colspan="' . count($this->columns) . '" style="padding: 0 !important">
                <a href="#" class="otherDetailsLink" onClick="g_toggleAdditional(\'g_DetailTable' . GuayaquilDetailsList::$table_no . '\', opennedimage, closedimage); return false;"> '.$this->GetLocalizedString('otherunitparts').'</a>
            </td>
        </tr>';
    }
}