...
<?php
    ...
    class GuayaquilQuickDetailsList extends GuayaquilTemplate
    {
        ...
        protected function DrawCategory($category)
        {
            ...
            $html = '<div class="gdCategory">'/*.$this->DrawCategoryContent($category)*/;
        ...
        protected function DrawUnit($unit)
        {
            ...
            <a href='.$link.' class="block_name">Деталь найдена в узле '.$unit["code"].'</a>
            '.$this->DrawUnitDetails($unit).'
            <a href="'.$link.'" class="otherDetailsLink" > '.$this->GetLocalizedString('otherunitparts').'</a>
            </td>
            </tr>
            </table>';
        }
        ...
        protected function DrawUnitImage($unit)
        {
            ...
            */
            ...
            <a href="'.$link.'" class="block_name">'.$unit['name'].'</a>
            <a href="'.$link.'">
