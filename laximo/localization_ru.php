...
abstract class LanguageTemplate implements IGuayaquilExtender {
    ...
    public static $language_data = array(
        ...
        'searchbymodel' => 'Поиск по номеру модели',
        ...
        'inputmodel' => 'Введите номер модели, например ',
        ...
        'otherunitparts' => 'Показать все детали узла',
        'enter_group_name' => 'Быстрый поиск детали/узла',
