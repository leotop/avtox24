...
<table class="tecdoc modifications silver_table_none_top">
	...
	<tbody>
	    ...
	    foreach ($arResult['MODIFICATIONS'] as $modification) {
	    	...
	    	$out .= '</td><td>';
	    	$out .= '<a class="m_select" href="' . $arParams['SEF_FOLDER'] . htmlspecialcharsex($arResult['brand_id']) . '/' . $arResult['model_id'] . '/' . htmlspecialcharsex($modification['carId']) . '/"> ' . htmlspecialcharsex($modification['carName']) . '</a>';
	        $out .= '</td>';
	        $out .= '
