                    ...
                    <td class="lm-auto-tecdoc-img">
                    	<? if ($part['image']) { ?>
                        	<a href="<?= htmlspecialchars($part['image']) ?>" class="zoom">
                        		<img src="<?= htmlspecialchars($part['image']) ?>?w=50&h=50" alt="<?= htmlspecialchars($part['genericArticleName'] . ' ' . $part['brandName'] . ' ' . $part['articleNo'])?>" title="<?=htmlspecialchars($part['genericArticleName'] . ' ' . $part['brandName'] . ' ' . $part['articleNo']) ?>" width="50" />
                        	</a>
                    	<? } ?>
                    </td>
                <? } ?>
