...
// Установка доступов
if($this->InstallTasks()) {
    ShowError(GetMessage('LM_AUTO_MAIN_ERROR_INSTALL_TASKS'));
}
...
// Добавление пользовательские свойства.
if (!$this->InstallUserFields()) {
    ShowError(GetMessage('LM_AUTO_BRANCHES_ERROR_INSTALL_USER_FIELDS'));
}