...
$arTemplates = array(
    ...
    array(
        ...
        'MESSAGE'       => "#NAME# #LAST_NAME#,<br />\nна ваш запрос по VIN #VIN# (#ID#) поступил ответ<br />\nот вашего менеджера #MANAGER#:<br />\n<br />\n#ANSWER#<br />\nВы можете просмотреть ответ, перейдя по следующей ссылке:<br />\n <a href=\"http://#SERVER_NAME#/auto/vin/#ID#/\">http://#SERVER_NAME#/auto/vin/#ID#/</a><br />\n<br />\nСообщение сгенерировано автоматически.\n#SITE_NAME#"
    ),
    ...
    array(
        'ACTIVE'        => 'Y',
        'EVENT_NAME'    => 'LM_AUTO_TASK_PRICE_TEST',
        'LID'           => '',
        'EMAIL_FROM'    => '#DEFAULT_EMAIL_FROM#',
        'EMAIL_TO'      => '#EMAIL#',
        'BODY_TYPE'     => 'html',
        'SUBJECT'       => '#SITE_NAME#: Тестирование прайслиста',
        'MESSAGE'       => "Информационное сообщение сайта #SITE_NAME#<br/>------------------------------------------<br/>Вам доступен новый сконвертированный прайслист для тестирования:<br/><a href=\"http://#SERVER_NAME##TESTED_FILE#\">Сконвертированный прайслист</a>.<br/><a href=\"http://#SERVER_NAME##STANDARD_FILE#\">Эталонный прайслист</a>.<br/><br/><br/>Сообщение сгенерировано автоматически."
    ),
	...
	array(
		...
		'MESSAGE'       => "Информационное сообщение сайта #SITE_NAME#<br/>------------------------------------------<br/>Статус заказа номер #ORDER_ID# от #ORDER_DATE# изменен.<br/>Новый статус заказа:<br/>#ORDER_STATUS#<br/>#ORDER_DESCRIPTION#<br/>#TEXT#<br/>#SITE_NAME#"
	),
