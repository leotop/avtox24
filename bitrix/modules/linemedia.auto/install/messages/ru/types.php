...
$arTypes = array(
    ...
    'LM_AUTO_TASK_PRICE_TEST'=> array(
        array(
            'LID'           => 'ru',
            'EVENT_NAME'    => 'LM_AUTO_TASK_PRICE_TEST',
            'NAME'          => 'LINEMEDIA.AUTO: Ссылка на тестовый прайслист',
            'DESCRIPTION'   => "#TESTED_FILE# - тестовый файл\n#STANDARD_FILE# - эталонный файл\n\n"
        ),
         array(
            'LID'           => 'en',
            'EVENT_NAME'    => 'LM_AUTO_TASK_PRICE_TEST',
            'NAME'          => 'LINEMEDIA.AUTO: Link to test pricelist',
            'DESCRIPTION'   => "#TESTED_FILE# - тестовый файл\n#STANDARD_FILE# - дата заказа\n"
        )
    ),

	'SALE_STATUS_CHANGED'=> array(
		array(
			'LID'           => 'ru',
			'EVENT_NAME'    => 'SALE_STATUS_CHANGED',
			'NAME'          => 'LINEMEDIA.AUTO: Смена статуса заказа',
