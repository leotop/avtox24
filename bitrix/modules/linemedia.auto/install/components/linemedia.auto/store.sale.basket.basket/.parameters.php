...
$arComponentParameters = Array(
	"PARAMETERS" => Array(
		...
		*/
		...
		"CHECK_BASKET_ITEMS" => array(
			"NAME" => GetMessage('SBB_CHECK_BASKET_ITEMS'),
			"TYPE" => "CHECKBOX",
			"MULTIPLE" => "N",
			"DEFAULT" => "N",
			"ADDITIONAL_VALUES" => "N",
		...
		"SORT_ITEM" => Array(
			"NAME"=>GetMessage("SORT_ITEMS"),
			"TYPE"=>"LIST", "MULTIPLE"=>"N",
			"VALUES"=>array(
				"PRICE" => GetMessage("SORT_PRICE"),
				"DATE_INSERT" => GetMessage("SORT_DATE"),
				"NAME" => GetMessage("SORT_TITLE")
		...
		"SORT_DIRECTION" => Array(
			"NAME"=>GetMessage("SORT_DIRECTION"),
			"TYPE"=>"LIST", "MULTIPLE"=>"N",
			"VALUES"=>array(
				"SORT_ASC" => GetMessage("SORT_ASC"),
				"SORT_DESC" => GetMessage("SORT_DESC"),
			),
			"DEFAULT"=>"DESC",
			"COLS"=>25,
			"ADDITIONAL_VALUES"=>"N",
