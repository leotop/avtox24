            ...
            <table class="lm-auto-vin-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="value">
                            <textarea name="MESSAGE" id="lm-auto-vin-message"><?= htmlspecialchars((string) $arResult['FIELDS']['MESSAGE']) ?></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="value">
                            <textarea name="extra" id="lm-auto-vin-extra"><?= htmlspecialchars((string) $arResult['FIELDS']['extra']) ?></textarea>
                        </td>
                    </tr>
                </tbody>
            </table>
