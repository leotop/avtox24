...
//        if(file_exists($_SERVER['DOCUMENT_ROOT'] . '/bitrix/php_interface/api_crosses_driver.php')) {
//
//            /****************************************************************/
//
//            include_once($_SERVER['DOCUMENT_ROOT'] . '/bitrix/php_interface/api_crosses_driver.php');
//
//            if(intval($arParams['ARTICLE_ID']) > 0) {
//
//
//            }
//
...
if($arResult['DETAIL']['articleDocuments']['array'][0]['analog'] == 1 && COption::GetOptionString('linemedia.auto', 'LM_AUTO_MAIN_SEARCH_ANALOGS_PHOTO', 'Y') == 'N') {
    $arResult['IMAGE'] = "/images/no_photo.png";
}
...
$applinceBrandList = $api->query('getApplinceBrandList', array(
	'article' => $arParams['ARTICLE'],
	'brand_title' => $arParams['BRAND'],
));
$arResult['applinceBrandList'] = $applinceBrandList['data'];
/*
