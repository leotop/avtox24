...
<?}?>
<?
function printPartsTable($parts, $group_id, $arParams) {
            ...
            <? if (!in_array('basket', $GLOBALS['LM_AUTO_SEARCH_RESULTS_HIDE_FIELDS'])) { ?>
                <td class="basket">
                    <noindex>
                        ...
                        <? if($part['express_buy']) {
                            $GLOBALS['APPLICATION']->IncludeComponent('linemedia:sale.order.express', '.default',
                                array(
                                    'PART' => $part['express_buy'],
                                    'EXPRESS_SALE_PERSON_TYPE_ID' => $arParams['EXPRESS_SALE_PERSON_TYPE_ID'],
                                    'ORDERS_URL' => '/auto/orders/',
                                ),
                                $component);
                        } ?>
                    </noindex>
