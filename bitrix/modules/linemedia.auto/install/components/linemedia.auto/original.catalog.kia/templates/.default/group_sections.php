...
<div class="lm-auto-catalog-original kia group_sections">
    ...
    <div class="group_section">
        <div class="group_sections_img">
			<a href="<?=$arParams['SEF_FOLDER'] . intval($arResult['MODEL']['ID_mod'])?>/<?=intval($arResult['GROUP_TYPE']['ID_typ'])?>/<?=intval($arResult['GROUP']['ID_grp'])?>/<?=$group_section['ID_sec']?>/<?=$arResult['ADDITIONAL_URL']?>">
        ...
        <div class="group_sections_title">
			<a href="<?=$arParams['SEF_FOLDER'] . intval($arResult['MODEL']['ID_mod'])?>/<?=intval($arResult['GROUP_TYPE']['ID_typ'])?>/<?=intval($arResult['GROUP']['ID_grp'])?>/<?=$group_section['ID_sec']?>/<?=$arResult['ADDITIONAL_URL']?>"><?=htmlspecialchars($group_section['Name'])?></a>
        </div>
