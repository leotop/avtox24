            ...
            <table class="lm-auto-vin-table table">
                ...
                <tbody>
                    ...
                    <?}else{?>
                        ...
                        <strong><?=GetMessage('LM_AUTO_VIN_ANSWER_MANAGER');?> <?=$arResult['DETAIL']['ANSWER_MANAGER']['LAST_NAME'];?> <?=$arResult['DETAIL']['ANSWER_MANAGER']['NAME'];?>
                            <?=$arResult['DETAIL']['ANSWER_MANAGER']['SECOND_NAME'];?> (<?=$arResult['DETAIL']['ANSWER_DATE'];?>)</strong><br /><br />
