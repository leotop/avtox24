...
/*
* Обработка кастомных страниц
*/
if(isset($arVariables['MODEL']) AND $arVariables['MODEL'] == 'part-info')
{
	unset($arVariables['MODEL']);
	$arVariables['ARTICLE_ID'] = $arVariables['GROUP_TYPE'];
}
if(isset($arVariables['MODEL']) AND $arVariables['MODEL'] == 'vin')
{
	unset($arVariables['MODEL']);
	$VIN = $arVariables['VIN'] = (string) $arVariables['GROUP_TYPE'];
}
