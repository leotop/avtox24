...
while ($arAccount = $dbResultList->NavNext(true, "f_"))
{
	...
	$arActions = Array();
	$arActions[] = array("ICON"=>"edit", "TEXT"=>GetMessage("SAA_UPDATE_ALT"), "ACTION"=>$lAdmin->ActionRedirect("linemedia.auto_account_edit.php?ID=".$f_ID."&lang=".LANG.GetFilterParams("filter_")), "DEFAULT"=>true);
	if ($saleModulePermissions >= "W")
	{
...
if ($saleModulePermissions >= "W")
{
	$aContext = array(
		array(
			...
			"LINK" => "linemedia.auto_account_edit.php?lang=".LANG.GetFilterParams("filter_"),
