...
function onBeforeUserSave_setGroupParam(&$arFields) {
...
/***************************************************** Код файла /bitrix/modules/main/admin/user_edit.php **********************************************************/
...
/*
 * Перечень кастомного кода
 * 1. $arPageSettings массив, содержащий константы и замены по коду мспользования этих констант
 * 2. событие обработки полей перед сохранением/добавлением OnBeforeUserSave
 * 3. событие в конце построения страницы - OnAfterUserEditPageBuild
 */
