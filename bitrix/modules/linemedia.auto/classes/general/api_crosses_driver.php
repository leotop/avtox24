...
class LinemediaAutoCrossesApiDriver {
    ...
    /*
     * ћаксимально возможное количество аргументов дл€ множественного запроса
     */
    ...
    public function getAnalogs2Multiple($args) {
        ...
        /*
         * ¬озможность перекрывать настройки
         */
        if(array_key_exists('options', $args) && is_array($args['options'])) {
        ...
        /*
         * ≈сли идет множественный запрос - не запрашиваем субаналоги
         */
        if(count($args) > 1) {
        ...
        /**
         * «ащита от черезмерного количества запросов
         */
