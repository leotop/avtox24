 ...
 * Запчасть
 */
$structures["Struct_LinemediaAuto_Product"] = array(
    ...
    "weight" 		=> array("varType" => "float"),
    "supplier_id" 	=> array("varType" => "string"),
    "modified"      => array("varType" => "string"),
	"CUSTOM_FIELDS"	=> array("varType" => "ArrayOfStruct_AssocArray", "arrType" => "Struct_AssocArray", "strict" => "no"),
);