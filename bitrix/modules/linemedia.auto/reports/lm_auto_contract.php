...
<table width="100%" align="center">
  ...
  <tr>
    <td>Адрес: <? echo $arParams["COUNTRY"].", ".$arParams["INDEX"].", г. ".$arParams["CITY"].", ".$arParams["ADDRESS"];?></td>
...
<br />
<br />
<p><b>Состав заказа</b> N: <?echo $ORDER_ID?>   от   <?echo $arOrder["DATE_INSERT_FORMAT"]?></p>
