...
for ($mi = 0; $mi < count($arBasketIDs); $mi++):
 ...
 <tr style='height:9.0pt'>
  ...
  padding:0cm 2.0pt 0cm 2.0pt;height:9.0pt'>
  <p class=Normal align=center style='margin:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><?echo SaleFormatCurrency($arQuantities[$mi]*($item_price), $arOrder["CURRENCY"], true);  $total_price += ($item_price)*$arQuantities[$mi];?></p>
  <p class=Normal align=center style='margin:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'>&nbsp;</p>
  </td>
  <td width=51 valign=top style='width:38.0pt;border-top:none;border-left:none;
  ...
  padding:0cm 2.0pt 0cm 2.0pt;height:9.0pt'>
  <p class=Normal align=center style='margin:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><?echo SaleFormatCurrency($nds_val, $arOrder["CURRENCY"], true); $total_nds += $nds_val;?></p>
  <p class=Normal align=center style='margin:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'>&nbsp;</p>
  </td>
  <td width=51 valign=top style='width:38.0pt;border-top:none;border-left:none;
  ...
  padding:0cm 2.0pt 0cm 2.0pt;height:9.0pt'>
  <p class=Normal align=center style='margin:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><?echo SaleFormatCurrency($arQuantities[$mi]*($item_price)+$nds_val, $arOrder["CURRENCY"], true); $total_sum += ($item_price)*$arQuantities[$mi]+$nds_val?></p>
  <p class=Normal align=center style='margin:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'>&nbsp;</p>
  </td>
 </tr>
