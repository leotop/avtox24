...
function add2cart(hash, url, max_available_quantity)
{
    ...
    url = url + '&quantity=' + quantity + '&max_available_quantity=' + max_available_quantity;
...
$(document).ready(function() {
    ...
    jQuery('.int').live('keyup', function(e) {
        var val = $(this).val();
        $(this).val(val.replace(/\D/g, ''));
    });

    jQuery('.int').live('blur', function() {
    ...
    jQuery('.maxvalue').live('keyup', function() {
    ...
    jQuery('#lm-auto-main-search-form-id').submit(function() {
