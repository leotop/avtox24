...
<form action="<?= $arResult['FORM_ACTION'] ?>" method="post" class="lm-auto-main-search-form" name="lm-auto-main-search-form" id="lm-auto-main-search-form-id" onsubmit="$(this).attr('action',
	'<?= $arResult['FORM_ACTION'] ?>'+encodeURIComponent($(this).find('#lm-auto-main-search-query-id').val())+'/');return true;">
