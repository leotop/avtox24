...
$arComponentParameters = array(
    "PARAMETERS" => array(
        ...
        'ANTI_BOTS' => array(
            "PARENT" => "BASE",
            "NAME" => GetMessage('LM_AUTO_MAIN_ANTI_BOTS'),
            "TYPE" => "CHECKBOX",
            "ADDITIONAL_VALUES" => "N",
            "MULTIPLE" => "N",
            "DEFAULT" => "N",
        ),
		'MANUAL_TECDOC_GROUPS' => array(
    		"PARENT" => "BASE",
    		"NAME" => GetMessage('LM_AUTO_MAIN_MANUAL_TECDOC_GROUPS'),
    		"TYPE" => "STRING",
    		"DEFAULT" => "",
    	),
        'SWIFT_FILTER' => array(
    		"PARENT" => "BASE",
    		"NAME" => GetMessage('LM_AUTO_MAIN_SWIFT_FILTER'),
    		"TYPE" => "CHECKBOX",
    		"DEFAULT" => "N",
    	),
    	'CONTEMPORARY_YEAR'=> array(
    		"PARENT" => "BASE",
    		"NAME" => GetMessage('LM_AUTO_MAIN_TECDOC_CATALOG_CONTEMPORARY_YEAR'),
    		"TYPE" => "STRING",
    		"ADDITIONAL_VALUES" => "N",
    		"MULTIPLE" => "N",
    	),
