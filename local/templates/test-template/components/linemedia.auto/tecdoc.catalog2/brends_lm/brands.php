...
<div>
    ...
    foreach ($arResult['BRANDS'] as $letter => $brands) {
        ...
        foreach ($brands as $brand) {
            ...
            $out .= '<div style="cursor:pointer;" onclick="location.href=\'' . $arParams['SEF_FOLDER'] . htmlspecialcharsEx($brand['manuId']) . '\'" class="car-logo ' . $logo_class . ' selflogo" '.$logo_style.'></div>';
