...
<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<?foreach($arResult["ITEMS"] as $arItem):?>
				...
				<div class="cnt<?if ($flag == 0) echo " active"?>" id="<?=$arItem["CODE"]?>">
					<?if($arItem["PROPERTY_TYPE"] == "N" && !isset($arItem["PRICE"])):?>
						...
						<div class="filter-responsive" style="margin-left: -6px;">
	...
	<?endif?>
		...
		<input type="submit" id="set_filter" name="set_filter" value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" class="btn btn-warning btn-small"/>
		<input type="submit" id="del_filter" name="del_filter" value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>" class="btn btn-small"/>
...
<script>
	...
	if ($.cookie("acstatus") == "open" || !$.cookie("acstatus")){
