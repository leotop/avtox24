...
if ($arResult['EDIT_MODE']) {
	?><form action="" method="post" id="tecdoc-items-edit-filter"><?
}

?>

<?$APPLICATION->AddHeadScript($this->GetFolder().'/js/jquery.selectbox.min.js');?>

<?/*<div class="tecdoc_quick_search">
	<i class="icon-custom-search-gray"></i>
