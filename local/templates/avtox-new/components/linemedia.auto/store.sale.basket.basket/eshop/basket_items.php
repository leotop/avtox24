...
<div class="cart-items" id="id-cart-list">
	...
	<thead>
		<tr>
		  <td class="lm-auto-main-cart-item-check"></td>
	...
	<div class="cart-ordering">
		...
		<div class="cart-buttons">
            <input type="submit" value="<?= GetMessage("SALE_DELETE_CHECKED") ?>" name="BasketRemove" />
			<input type="submit" value="<?= GetMessage("SALE_UPDATE") ?>" name="BasketRefresh" />
			<input type="submit" value="<?= GetMessage("SALE_ORDER") ?>" name="lm_BasketOrder"  id="basketOrderButton2" />
		</div>
	</div>
	<?else:
